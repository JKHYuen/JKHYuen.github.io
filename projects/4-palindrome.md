...
<img class="image center mini" src="{% link assets/images/palindrome-menu.jpg %}" alt="Quote Screenshot"/>
<em style="width: 100%;">Score display appears when one player runs out of revives.</em>
...
<video class="embedded-video mini" controls playsinline loop>
  <source src="{{ site.baseurl }}/assets/videos/palindrome-bullet.mp4" type="video/mp4">
  Bullet video
</video>
...
<video class="embedded-video mini" controls playsinline loop>
  <source src="{{ site.baseurl }}/assets/videos/palindrome-grenade.mp4" type="video/mp4">
  Grenade video
</video>
